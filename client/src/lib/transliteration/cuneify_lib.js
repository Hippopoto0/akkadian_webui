// sourced from https://andrewsenior.com/cuneify/
import { replace_accents, map_hex_codepoints, text_norm_input } from "./textnorm";
import { signlist } from "./singlist_alt"
// Take one transliteration unit and convert to a string, if possible.
export function map_one_chunk(sp) {
  var sp_orig = sp;
...
export function normed_unicode_to_cuneiform_lines(unicode_input) {
